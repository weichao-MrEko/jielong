...
Component({
  ...
  data: {
    ...
    upimg: [],
    pushurl: [],
    jieitem: [{ item_name: '', price: '', min_people: '', max_people:'', id: 0 }],
    group: [],
    groups: [
    ...
    jucantime:{jucandate:'',jutime:'00:00'},
  ...
  methods: {
    ...
    onLoad: function (options) {
      ...
      that.data.jucantime.jucandate=s3

      that.setData({
        startime: that.data.startime,
        hometime: ("0" + (M + 1)).slice(-2) + "/" + D,
        endtime: that.data.endtime,
        jucantime: that.data.jucantime,
        setPlnr: options.zhu,
        descont: options.nei,
    ...
    jucantime: function (e) {
      this.data.jucantime.jucandate = e.detail.value
      this.setData({
        jucantime: this.data.jucantime
      })
    },
    jutime:function(e){
      this.data.jucantime.jutime = e.detail.value
      this.setData({
        jucantime: this.data.jucantime
      })
    },
