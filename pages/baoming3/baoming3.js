...
Component({
  ...
  data: {
    ...
    height:163,
     ...
     upimg:[],
     pushurl: [],
    jieitem: [{ item_name: '', size: '',pic:'', amount: '', price: '',id:0}],
     group:[],
     groups: [
   ...
   //主题
    ...
    fajielong(ev){
      ...
      wx.request({
        ...
        data:{
          ...
          dragonTheme: thgt.zhuti.data.setPlnr,//
          item: thgt.data.jieitem,//
          img_path: thgt.zhuti.data.upimg,//
          descInfo: thgt.zhuti.data.descont,//
         ...
         /* actor_info: thgt.data.heti,*/
          ...
          pinfs:app.globalData.pinfs,//拼团方式的价格
          clustersnum: app.globalData.clustersnum,//拼团方式的总数
    ...
    delitem:function(e){    
     ...
     jieitem.splice(id,1)
      ...
      console.log(app.globalData.pintuanfs)
    },
    qitmu:function(){
